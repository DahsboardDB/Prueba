             ...
             <div class="bg-white py-2 collapse-inner rounded ">
              ...
              <div id="collapseuno" class="collapse" aria-labelledby="headingone" data-parent="#accordionSidebar">
                   ...
                   <% 
                     ...
                     dominios1= dominiosdao.ConsultarListadoDominios("6");

                       %>
                       <div name="DominioId">   
                   <% 
                    
                       for (Dominios D: dominios1) { %>
                     ...
                     dominios2= dominiosdao2.ConsultarListadoDominios("7");
                   ...
                   <% 
                       ...
                       <button Class="btn btn-outline-primary col-lg-6 mb-4"><a class="collapse-item" href="javascript:nuevo2()"><%= D.getNombreCampaña()%></a></button>
