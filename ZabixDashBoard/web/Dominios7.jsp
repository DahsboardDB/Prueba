                ...
                <button class="btn btn-primary" type="button">
                 ...
                 <div id="collapsejj" class="collapse" aria-labelledby="headingjj" data-parent="#accordionSidebar">
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo9()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo10()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo11()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                 ...
                 <Span>DOMINIO3</span>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo12()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo13()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo14()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo15()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo16()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo17()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                 ...
                 <Span>DOMINIO4</span>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo18()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                 ...
                 <Span>DOMINIO5</span>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo19()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo20()"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <div id="DominioId">
                         ...
                         <section>
                             <button class="btn btn-outline-primary col-lg-6 mb-4"><a href="javascript:nuevo21()"><%= D.getNombreCampaña() %></a></button>
                         </section>
