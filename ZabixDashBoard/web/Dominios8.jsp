            ...
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-primary" type="button">
                 ...
                 <div class="bg-white py-2 collapse-inner rounded ">
                 <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsenn" aria-expanded="true" aria-controls="collapsenn">
                 <i class="fas fa-fw fa"></i>
                 <Span>DOMINIO1</span>
                 </a> 
            
                 <div id="collapsenn" class="collapse" aria-labelledby="headingnn" data-parent="#accordionSidebar">
                       
                      <% 
                      
                     DominiosDAO dominiosdao = new DominiosDAO ();
                     ArrayList <Dominios> dominios = new ArrayList <Dominios> (); 
                     dominios= dominiosdao.ConsultarListadoDominios("34");
                   ...
                   <% 
                     ...
                     DominiosDAO dominiosdao2 = new DominiosDAO();
                     ArrayList <Dominios> dominios2 = new ArrayList <Dominios>();
                     dominios2 = dominiosdao2.ConsultarListadoDominios("35");
                 ...
                 <div id="collapsejj" class="collapse" aria-labelledby="headingjj" data-parent="#accordionSidebar">
                       ...
                       <%
                         ...
                         dominios3 = dominiosdao3.ConsultarListadoDominios("36");
                     ...
                     <%
                         ...
                         dominios4 = dominiosdao4.ConsultarListadoDominios("37");
                     ...
                     <div id="DominioId">
                         ...
                         <script>
                             ...
                             function nuevo4 () {
                                 ...
                                 document.getElementById("ventt").style.display="block";
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("38");
                     ...
                     <div id="DominioId">
                         ...
                         <iframe class="" id="ventt" src="<%= D.getNombreAplicacion() %>"></iframe>
                         
                         <section>
                             <button><a href="javascript:nuevo5"><%= D.getNombreCampaña() %></a></button>
                         </section>
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("39");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("40");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("41");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("42");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("43");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("44");
                     ...
                     <%
                         ...
                         dominios5 = dominiosdao5.ConsultarListadoDominios("45");
