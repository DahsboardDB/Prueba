                ...
                <button class="btn btn-primary" type="button">
                 ...
                 <div id="collapsejj" class="collapse" aria-labelledby="headingjj" data-parent="#accordionSidebar">
                       ...
                       <%
                         ...
                         dominios = dominiosdao.ConsultarListadoDominios("64");
                       ...
                       <div id="DominioId">
                           ...
                           <%
                            ...
                            <iframe class="DO5" id="ventaaa" src="<%= D.getNombreAplicacion() %>"></iframe>
                            
                            <section id="contenedor">
                                <button><a href="javascript:nuevo3()"><%= D.getNombreCampaña() %> </a></button>
                            </section>
                            ...
                            function nuevo3 () {
                                ...
                                document.getElementById("ventaa").style.display="Block";
                     ...
                     <%
                         ...
                         dominios4 = dominiosdao4.ConsultarListadoDominios("65");
                     ...
                     <div id="DominioId">
                         ...
                         <iframe class="DO7" id="ventt" src="<%= D.getNombreAplicacion() %>"></iframe>
